...
bot = telebot.TeleBot('7975440718:AAF74Qqh5jN8zfht_p_R4jrJT24uohVhiTo')

# Admin ID
ADMINS = {7232732142}  # Add more admin IDs if needed
OWNER_ID = 6240986259
# Attack settings
nxtlvl_PATH = "./bgmi"
MAX_CONCURRENT_ATTACKS = 10 # Set the maximum number of concurrent attacks
...
REQUIRED_CHANNELS = ["@bgmiop00", "@public_chat_girl"]  # Add required channels here
...
def handle_attack(message):
    ...
    if not is_user_member(user_id):
        ...
        bot.reply_to(message, 
                   ...
                   f"➡️ [Join Channel 1](https://t.me/bgmiop00)\n"
                   f"➡️ [Join Channel 2](https://t.me/public_chat_girl)",  parse_mode="Markdown", disable_web_page_preview=True
                )
        return
