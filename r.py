...
bot = telebot.TeleBot('7870561205:AAEwV1g0vokpOwaTiO_U8LMNUmlS-ibzb38')
...
REQUIRED_CHANNELS = ["@yetoviphai", "@ddos_maro"]  # Add required channels here
...
def handle_attack(message):
    ...
    if not is_user_member(user_id):
        ...
        bot.reply_to(message, 
                   ...
                   f"➡️ [Join Channel 2](https://t.me/ddos_maro)",  parse_mode="Markdown", disable_web_page_preview=True
                )
        return
